...
//   REQ-LOGIC-RISK-001  Risk score shall be deterministic for fixed inputs
//   REQ-LOGIC-RISK-002  Risk score shall clamp to [0, 10]
//   REQ-LOGIC-RISK-003  Risk level buckets shall be stable (low/medium/high/critical)
//   REQ-LOGIC-DEFAULT-001 Defaults shall be defined for every iQube type/category
//   REQ-LOGIC-DEFAULT-002 Fields marked secret shall never leak in non-secret lists
//
// Aerospace framing: these are "unit tests" on pure business logic. They are
// fast, deterministic, and hermetic — no I/O, no network, no time. They are
// the test-pyramid's base: cheap, numerous, and regress on every commit.
// ─────────────────────────────────────────────────────────────────────────────

// ─── Risk score calculation ───────────────────────────────────────────────────

describe('REQ-LOGIC-RISK-001/002 calculateRiskScore', () => {
...
describe('REQ-LOGIC-RISK-003 getRiskLevel', () => {
  it('score 0–3 → low', () => {
...
describe('REQ-LOGIC-DEFAULT-001 getDefaultSensitivity', () => {
...
describe('REQ-LOGIC-DEFAULT-002 getDefaultFields', () => {
